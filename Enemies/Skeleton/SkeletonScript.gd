...
func _process(_delta):
	if get_tree().get_root().has_node('SceneHandling/Game/YSort/Player') == true:
		var player_pos = get_tree().get_root().get_node('SceneHandling/Game/YSort/Player').global_position
