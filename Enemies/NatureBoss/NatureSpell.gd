...
var damage = 0.5 * PlayerStats.MODIFIER
var damageEffect = 'Nature'
var damageName = 'Spell'
...
onready var trail = $OrbitalParticles
...
func _playerOffset(position):
	randomize()
	var randomOffset = rand_range(-25,25)
