...
var damage = 1 * PlayerStats.MODIFIER
...
#	var iceExplosionInstance = IceExpolsion.instance()
#	get_parent().add_child(iceExplosionInstance)
#	iceExplosionInstance.global_position = global_position
	queue_free()
